...
class Problem(models.Model):
    ...
    time_limit = models.CharField(max_length=20, null=False, blank=False)
    memory_limit = models.CharField(max_length=20, null=False, blank=False)
    ...
    spj = models.BooleanField(default=False, null=False, blank=False)
